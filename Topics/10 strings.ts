...
// 1 - String charAt() :-
let strr = new String("This is string");
...
// -------------------------------------------------------
// 2 - String charCodeAt() :-
let st = new String("This is string");
...
let indexx = str1.indexOf("one");
console.log("indexOf found One :" + indexx);
console.log("");

// -------------------------------------------------------
// 5 - String lastIndexOf() :- Index of specified word which is the last word in the string
let str111 = new String("This is string one and again string one");
let indexxx = str1.lastIndexOf("string");
...
let str1111 = new String("This is beautiful string");
let inde = str1.localeCompare("This is beautiful string");
...
// 8 - String replace() :-
// let re = /apples/gi;
let strng = "Apples are round, and apples are juicy.";
let newstr = strng.replace(/apples/gi, "oranges");
console.log(newstr);
console.log("");
...
let re = /apples/gi;
let strn = "Apples are round, and apples are juicy.";
if (strn.search(re) == -1) {
...
let strg = "Apples are round, and apples are juicy.";
let sliced = strg.slice(3, -2);
...
let strrn = "Apples are round, and apples are juicy.";
...
let strnn = "Apples are round, and apples are juicy.";
...
let strngg = "Apples are round, and apples are juicy.";
let splitted = strngg.split(" ", 3);
console.log("splitted :- ", splitted);
console.log("");

// -------------------------------------------------------
// 14 - String toLowerCase() :- This method returns the calling string value converted to lowercase.
let sttr = "Apples are round, and Apples are Juicy.";
...
let stttr = "Apples are round, and Apples are Juicy.";
...
let sstr = "Apples are round, and Apples are Juicy.";
...
let ssttr = "Apples are round, and Apples are Juicy.";
