...
console.log(
  "Maximum value that a number letiable can hold: " + Number.MAX_VALUE
);
console.log(
  "The least value that a number letiable can hold: " + Number.MIN_VALUE
);
